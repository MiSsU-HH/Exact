...
def get_dataloaders(config, is_dist=False):
    ...
    if 'PASTIS' in train_config['dataset']:
        ...
        dataloaders['train'] = get_pastis_dataloader(
            ...
            return_paths=train_config['return_paths'], pseudo_path=train_config['pseudo_path'], is_dist=is_dist)
    ...
    if 'PASTIS' in eval_config['dataset']:
        return_paths = eval_config['return_paths'] if "return_paths" in eval_config else False
        dataloaders['eval'] = get_pastis_dataloader(
            ...
            return_paths=return_paths, pseudo_path=False, is_dist=is_dist)
